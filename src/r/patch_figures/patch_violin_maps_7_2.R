...
path7_m <- "./figures/brains_0_1/microstate_map_00.png"
path2_m <- "./figures/brains_0_1/microstate_map_01.png"
...
ggsave("./figures/ORDERED_Combined_2x2_Tight.tiff", 
       final_2x2, width = 12, height = 9, dpi = 1000, compression = "lzw")
